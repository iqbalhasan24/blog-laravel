...
<style>
 ...
 <div class="container"> 
    ...
    @if(isset($page->content_title))<div class="row"><div class="col-md-12"><h3>{!! $page->content_title !!}</h3></div></div>@endif      

    {!! $page->content!!}

    @if(isset($page->description_title))<div class="row"><div class="col-md-12"><h3>{!! $page->description_title !!}</h3></div></div>@endif

    {!! $page->short_description!!}

    @if(isset($page->aws_support_documentation_title))<div class="row"><div class="col-md-12"><h3>{!! $page->aws_support_documentation_title !!}</h3></div></div>@endif 
