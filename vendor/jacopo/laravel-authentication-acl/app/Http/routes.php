...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::group(['middleware' => ['admin_logged', 'can_see']], function () {
        ...
        ///////////////////
        Route::get('/admin/users/list1', [ 
            'as' => 'users.list1',
            'uses' => 'LaravelAcl\Authentication\Controllers\UserController@getListForPermission'
        ]);
        Route::post('/admin/users/pages', [
            'as' => 'users.pages',
            'uses' => 'LaravelAcl\Authentication\Controllers\UserController@getPageList'
        ]);
        Route::post('/admin/users/add_permission', [
            'as' => 'users.add_permission',
            'uses' => 'LaravelAcl\Authentication\Controllers\UserController@addorRemovePagePermission'
        ]);
        /////////////////
